...
; NOTEPAD++ -------------------------------------------------------------------------------------------
#IfWinActive earthshaker.ahk - Notepad++
~^S::
...
; NOTEPAD ---------------------------------------------------------------------------------------------
#IfWinActive earthshaker - Notepad
~^S::
	 ; Reload, %A_ScriptDir%\\%A_ScriptName%
	Reload, A_ScriptFullPath
Return
...
; SUBLIME TEXT ----------------------------------------------------------------------------------------
#IfWinActive earthshaker.ahk - Sublime Text
~^S::
	Reload, A_ScriptFullPath
Return

; VISUAL STUDIO CODE ----------------------------------------------------------------------------------
#IfWinActive earthshaker.ahk - Visual Studio Code
~^S::
	 ; Reload, %A_ScriptDir%\\%A_ScriptName%
	Reload, A_ScriptFullPath
Return
...
~x & RButton::
		SendInput, {1}
		SendInput, {LButton}
		SendInput, r	;ULTIMATE

		; SendInput, b 	;REFRESHER ITEM 
...
/*
		Sleep, 50
		SendInput, c 	;ARCANE OR SOUL RING
		SendInput, v	;ARCANE OR SOUL RING
		SendInput, z 	;REFRESHER ITEM 
		Sleep, 100
		SendInput, c	;ARCANE OR SOUL RING
		SendInput, v	;ARCANE OR SOUL RING
		Sleep, 50
