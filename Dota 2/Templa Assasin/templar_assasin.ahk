...
; NOTEPAD++ -------------------------------------------------------------------------------------------
#IfWinActive templar_assasin.ahk - Notepad++
~^S::
...
; NOTEPAD ---------------------------------------------------------------------------------------------
#IfWinActive templar_assasin - Notepad
~^S::
	; Reload, %A_ScriptDir%\\%A_ScriptName%
	Reload, A_ScriptFullPath
Return
...
; SUBLIME TEXT ----------------------------------------------------------------------------------------
#IfWinActive templar_assasin.ahk - Sublime Text
~^S::
	Reload, A_ScriptFullPath
Return

; VISUAL STUDIO CODE ----------------------------------------------------------------------------------
#IfWinActive templar_assasin.ahk - Visual Studio Code
~^S::
	; Reload, %A_ScriptDir%\\%A_ScriptName%
	Reload, A_ScriptFullPath	
Return
