...
; NOTEPAD++ -------------------------------------------------------------------------------------------
#IfWinActive life_stealer.ahk - Notepad++
~^S::
...
; NOTEPAD ---------------------------------------------------------------------------------------------
#IfWinActive life_stealer - Notepad
~^S::
	 ; Reload, %A_ScriptDir%\\%A_ScriptName%
	Reload, A_ScriptFullPath
Return
...
; SUBLIME TEXT ----------------------------------------------------------------------------------------
#IfWinActive life_stealer.ahk - Sublime Text
~^S::
	Reload, A_ScriptFullPath
Return

; VISUAL STUDIO CODE ----------------------------------------------------------------------------------
#IfWinActive life_stealer.ahk - Visual Studio Code
~^S::
	 ; Reload, %A_ScriptDir%\\%A_ScriptName%
	Reload, A_ScriptFullPath
Return
