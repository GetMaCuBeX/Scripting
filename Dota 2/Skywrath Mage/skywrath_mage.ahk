...
; NOTEPAD++ -------------------------------------------------------------------------------------------
#IfWinActive skywrath_mage.ahk - Notepad++
~^S::
...
; NOTEPAD ---------------------------------------------------------------------------------------------
#IfWinActive skywrath_mage - Notepad
~^S::
	 ; Reload, %A_ScriptDir%\\%A_ScriptName%
	Reload, A_ScriptFullPath
Return
...
; SUBLIME TEXT ----------------------------------------------------------------------------------------
#IfWinActive skywrath_mage.ahk - Sublime Text
~^S::
	Reload, A_ScriptFullPath
Return

; VISUAL STUDIO CODE ----------------------------------------------------------------------------------
#IfWinActive skywrath_mage.ahk - Visual Studio Code
~^S::
	 ; Reload, %A_ScriptDir%\\%A_ScriptName%
	Reload, A_ScriptFullPath
Return
